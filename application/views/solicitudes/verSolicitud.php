...
<div class="container">
      ...
      <a href="<?php 
     $use=$meta[0];
      echo base_url()."Solicitudes/viewpdf?id=".$use->folio."&to=0";?>" target="_blank" class="btn waves-effect light-blue darken-2">Descargar PDF<i class="material-icons right">cloud_download</i></a>
      </div> 
        </body>
